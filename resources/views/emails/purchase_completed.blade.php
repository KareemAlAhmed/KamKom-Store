        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">Dear {{$buyer->firstName}} , here is a summary of your recent order. If you have any questions or concerns about your order, please <a href="mailto:karimahmad2172@gmail.com?subject=Feedback%20on%20Website&body=Hi%20there,">Contact Us</a>.</p>
            </td>
          </tr>
          <!-- end copy -->
            ...
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  ...
                  <td align="left" bgcolor="#D2C7BA" width="25%" style="padding: 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;"><strong>{{$purchId}}</strong></td>
                </tr>
                <?php 
                        foreach($products as $prod=>$value){
                            $pd=Product::find($prod);
                            $total=$value->quantity * $pd->price;
                            echo "<tr>";
                            echo("<td class='item' align='left' width='75%' >{$pd->name}*{$value->quantity} </td>");
                            echo("<td class='item' align='left' width='25%' >$$total </td>");
                            echo "</tr>";
                            // echo("<p>$pd->name * " . $value->quantity  . " that cost $".$value->quantity * $pd->price  . "</p>");
                        }
                ?>
                <!-- <tr>
                ...
                <tr> 
                  ...
                  <td align="left" width="25%" style="padding: 12px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-top: 2px dashed #D2C7BA; border-bottom: 2px dashed #D2C7BA;"><strong>${{$cost}}</strong></td>
                </tr>
              </table>
            </td>
          </tr>
